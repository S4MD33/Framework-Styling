...
class FW_Styling_Css_Generator {
	...
	private static function generate_option_css( $blocks, $saved_settings ) {
		...
		foreach ( $blocks as $block_id => $block_settings ) {
			...
			$css  .= apply_filters( 'fw_ext_styling_generate_links_css', '', $css_selectors, $links, $saved_settings['blocks'][ $block_id ] );
	...
	private static function generate_typography_css( $css_selectors, $elements, $settings ) {
		...
		$css = apply_filters( 'fw_ext_styling_generate_typography_css', '', $css_selectors, $typography_tags, $settings );
    ...
    $css = '';
		...
		$css = apply_filters( 'fw_ext_styling_generate_background_css', '', $css_selectors, $elements, $settings );
		$nobg = apply_filters( 'fw_ext_styling_generate_background_css_nobg', array(), $css_selectors );
